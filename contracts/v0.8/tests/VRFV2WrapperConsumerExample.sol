...
contract VRFV2WrapperConsumerExample is VRFV2WrapperConsumerBase, ConfirmedOwner {
  ...
  constructor(address _wrapperNativeToken, address _vrfV2Wrapper)
    ConfirmedOwner(msg.sender)
    VRFV2WrapperConsumerBase(_wrapperNativeToken, _vrfV2Wrapper)
  {}
  ...
  function makeRequest(
    ...
    uint256 paid = VRF_WRAPPER.calculateRequestPrice(_callbackGasLimit);
